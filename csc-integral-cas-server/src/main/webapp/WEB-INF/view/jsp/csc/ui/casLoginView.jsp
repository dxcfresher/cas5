...
response.addHeader("X-Content-Type-Options", "nosniff"); //ICAS-57
response.addHeader("X-Frame-Options", "SAMEORIGIN"); //ICAS-50
response.addHeader("X-XSS-Protection", "1; mode=block"); //ICAS-59
response.addHeader("X-Content-Security-Policy", "default-src 'self';"); // ICAS-58
